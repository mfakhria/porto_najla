...
**Vibe:** Bright feminine pastel theme — blush pink, lavender, cream, dan soft mint — dengan deep-plum typography, bold display serif (Instrument Serif), dan cinematic scroll-driven motion
**Arsitektur:**
...
6. **SkillsSection** (BarChart 4 skill: React, TypeScript, Node.js, Tailwind CSS — palet 2 warna rose/lavender pastel)
...
@theme {
  ...
  --color-accent-secondary: var(--sem-accent-secondary);
...
/* ============================== */
/* SEMANTIC TOKENS — bright feminine pastel palette */
/* ============================== */

:root {
  /* Default / fallback: soft blush */
  --sem-bg-base: #fff8fb;
  --sem-bg-elevated: #ffffff;
  --sem-bg-contrast: #6d5575;
  --sem-fg-primary: #4f3f56;
  --sem-fg-muted: #88758f;
  --sem-fg-inverted: #fff9fc;
  --sem-accent-primary: #f3a9c4;
  --sem-accent-secondary: #d8c5e8;
  --sem-accent-on: #4b3341;
  --sem-border-subtle: rgba(122, 88, 119, 0.16);
  --sem-border-strong: #cf9fba;
  --candy-bg-color: #f8e5ef;
}

.light {
  /* Alias tetap disediakan agar class .light lama tidak rusak */
  --sem-bg-base: #fff8fb;
  --sem-bg-elevated: #ffffff;
  --sem-bg-contrast: #6d5575;
  --sem-fg-primary: #4f3f56;
...
[data-theme="loader"] {
  --sem-bg-base: #fff2f7;
  --sem-bg-elevated: #ffe7f0;
  --sem-fg-primary: #543e4b;
  --sem-fg-muted: #947684;
  --sem-accent-primary: #f2a4bf;
  --sem-accent-secondary: #dac7eb;
  --sem-accent-on: #4b3341;
  --sem-border-subtle: rgba(139, 92, 119, 0.14);
}

[data-theme="hero"] {
  --sem-bg-base: #fff8fb;
  --sem-bg-elevated: #fcecf4;
  --sem-fg-primary: #4f3f56;
  --sem-fg-muted: #88758f;
  --sem-accent-primary: #f3a9c4;
  --sem-accent-secondary: #ddc9ed;
  --sem-accent-on: #4b3341;
  --sem-border-subtle: rgba(122, 88, 119, 0.14);
}

[data-theme="projects"] {
  --sem-bg-base: #faf5ff;
  --sem-bg-elevated: #ffffff;
  --sem-fg-primary: #51445c;
  --sem-fg-muted: #887b95;
  --sem-accent-primary: #cdb7e6;
  --sem-accent-secondary: #f3b7cb;
  --sem-accent-on: #44364d;
  --sem-border-subtle: rgba(104, 83, 126, 0.14);
}

[data-theme="services"] {
  --sem-bg-base: #fff9ed;
  --sem-bg-elevated: #fffdf8;
  --sem-fg-primary: #584a4d;
  --sem-fg-muted: #938080;
  --sem-accent-primary: #f3b6c8;
  --sem-accent-secondary: #e8cfad;
  --sem-accent-on: #4d3a40;
  --sem-border-subtle: rgba(132, 102, 92, 0.14);
}

[data-theme="skills"] {
  --sem-bg-base: #f5fbf8;
  --sem-bg-elevated: #ffffff;
  --sem-fg-primary: #40534d;
  --sem-fg-muted: #768b84;
  --sem-accent-primary: #f1afc3;
  --sem-accent-secondary: #cbbce3;
  --sem-accent-on: #49343d;
  --sem-border-subtle: rgba(76, 108, 97, 0.14);
  --candy-bg-color: #dcefe8;
}

[data-theme="testimonials"] {
  --sem-bg-base: #fff5f8;
  --sem-bg-elevated: #ffffff;
  --sem-fg-primary: #533f4c;
  --sem-fg-muted: #917581;
  --sem-accent-primary: #efabc1;
  --sem-accent-secondary: #d8c2e7;
  --sem-accent-on: #49333c;
  --sem-border-subtle: rgba(128, 88, 108, 0.14);
}

[data-theme="nav"] {
  --sem-bg-base: #fff8fb;
  --sem-bg-elevated: #fffafd;
  --sem-bg-contrast: #705875;
  --sem-fg-primary: #4f3f56;
  --sem-fg-muted: #846f8c;
  --sem-fg-inverted: #fff9fc;
  --sem-accent-primary: #eea4bf;
  --sem-accent-secondary: #d6c2e7;
  --sem-accent-on: #49333d;
  --sem-border-subtle: rgba(117, 82, 113, 0.16);
}
...
export function SocialIcons({
  ...
  return (
    <div
      className={cn(
        "relative flex items-center gap-0.5 px-1.5 py-1.5 rounded-2xl bg-bg-elevated/70 backdrop-blur-xl border border-border-subtle shadow-[0_10px_32px_rgba(112,80,108,0.14)]",
        className
      )}
    >
    ...
    <>
      <motion.header
        ...
        className={cn(
          ...
          "shadow-[0_10px_32px_rgba(112,80,108,0.14)]",
    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          style={{
            backgroundImage:
              "linear-gradient(to bottom right, var(--color-fg-primary) 28%, rgba(143,104,139,0.58))",
          }}
        >
          {title}
        </motion.h1>
...
> Catatan palet: bar yang `highlight: true` pakai `bg-accent-primary` (pastel rose); skill biasa pakai `bg-accent-secondary` (pastel lavender). Tooltip "main stack" hanya muncul di highlighted bar.
...
const BarChart = ({
  ...
  // Two-tone pastel palette: highlighted skills use rose accent, others use lavender accent
  ...
  const style = {
    ...
    color: highlight ? "bg-accent-primary" : "bg-accent-secondary",
...
Tema baru dibuat untuk memberi kesan **bright, warm, feminine, soft, dan approachable** tanpa membuat portfolio terasa kekanak-kanakan. Warna pastel dipakai sebagai surface dan accent, sedangkan teks memakai deep plum / muted charcoal supaya kontras dan readability tetap kuat.

| Section            | `data-theme`     | Background | Accent utama | Note |
| ------------------ | ---------------- | ---------- | ------------ | ---- |
| Loader             | `loader`         | `#fff2f7`  | Rose `#f2a4bf` | Soft blush opening, fade-out setelah 3 detik |
| NavBar / MobileNav | `nav`            | translucent `#fffafd` + blur | Rose `#eea4bf` | Glassy pastel pill, tetap menyusut saat scroll |
| Hero               | `hero`           | `#fff8fb`  | Rose `#f3a9c4` | Grid lembut + radial pastel edge |
| Projects           | `projects`       | `#faf5ff`  | Lavender `#cdb7e6` | Membuat gambar project tetap jadi fokus utama |
| Services           | `services`       | `#fff9ed`  | Rose `#f3b6c8` | Warm cream untuk memisahkan section dari Projects |
| Skills             | `skills`         | `#f5fbf8`  | Rose + Lavender | BarChart 2-warna pastel; candy pattern jadi soft mint |
| Testimonials       | `testimonials`   | `#fff5f8`  | Rose `#efabc1` | Soft blush surface dengan white cards |
| Footer             | `projects` reuse | `#faf5ff`  | Lavender `#cdb7e6` | Glow pastel menyatu ke atas dan bawah |
| SocialDock         | `nav`            | glassy white-pink | Rose `#eea4bf` | Desktop only, fixed bottom-center |

**Core palette:**
- Blush background: `#fff8fb`
- Soft lavender background: `#faf5ff`
- Warm cream background: `#fff9ed`
- Soft mint background: `#f5fbf8`
- Primary rose: `#f3a9c4`
- Secondary lavender: `#d8c5e8`
- Deep plum text: `#4f3f56`
- Muted plum text: `#88758f`

**Aturan akses token (yang berlaku di seluruh app):**
- Background: `bg-bg-base` (utama), `bg-bg-elevated` (card/elevated), `bg-bg-contrast` (deep-plum contrast untuk mobile-nav toggle)
- Foreground: `text-fg-primary` (heading/body), `text-fg-muted` (subtitle), `text-fg-inverted` (di atas bg-contrast)
- Accent utama: `bg-accent-primary` / `text-accent-primary` (rose/lavender sesuai section)
- Accent sekunder: `bg-accent-secondary` / `text-accent-secondary` (pendamping pastel, terutama Skills)
- Accent text: `text-accent-on` untuk teks di atas accent surface
...
**Design rule:** hindari mengganti pastel surface menjadi warna yang terlalu saturated. Kalau menambah komponen baru, prioritaskan `bg-bg-elevated`, `border-border-subtle`, `text-fg-primary`, `text-fg-muted`, dan semantic accent token daripada hard-coded color agar section theme tetap konsisten.
...
2. **Hero**: title serif besar, rose pastel radial edge di bagian bawah, CTA "View Projects".
3. **Featured Work**: heading center, lalu 7 gambar zoom-parallax dengan scroll panjang (300vh).
4. **Our Services**: 5 service text di kiri, image preview di kanan, hover text → pastel rose + slide animation.
5. **Skills & Tools**: 4 vertical bar (React pastel rose, TS/Node/Tailwind pastel lavender) dengan logo dan tooltip "main stack" hanya di React.
6. **Words from collaborators**: 3 testimonial card, item tengah memakai gaya `quote` (no card bg).
7. **Footer**: glow lavender pastel menyatu ke atas, brand + 3 column link, di mobile 3-column compact.
...
Selesai — struktur, motion, dan behavior tetap mengikuti kode yang sudah ada di repo, dengan visual theme baru berupa bright feminine pastel palette.
